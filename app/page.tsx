      ...
      <section className="relative -top-6 min-h-screen flex items-center justify-start overflow-hidden">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2">
          <div className="w-5 h-8 border border-white/40 flex justify-center">
            <div className="w-0.5 h-2 bg-white/60 mt-1.5 animate-bounce" />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-3 md:px-0">
          ...
          <div className="md:hidden space-y-6">
            {[
              ...
              <div
                key={idx}
                className=" bg-white p-6 flex flex-col w-full mx-auto max-w-md rounded-lg border border-gray-300"
              >
